...
import { getIdiomas, getIdiomasCount } from "@/app/api-endpoints/idioma";

const IdiomaIntro = ({ refreshKey = 0 }) => {
        ...
        const cargarResumen = async () => {
            try {
                const [totalResponse, registros] = await Promise.all([
                    getIdiomasCount(),
                    getIdiomas(JSON.stringify({ fields: { activoSn: true, iso: true } })),
                ]);
                ...
                console.error("No se pudo cargar el resumen de idiomas", error);
            }
        };
    ...
    return (
        <section className="neat-page-intro">
            <div className="neat-page-heading">
                <h1>Idiomas</h1>
                <p>
                    Idiomas en los que se ofrece la plataforma. Cada usuario podrá elegir uno de los idiomas activos en su perfil.
                </p>
            </div>

            <div className="neat-page-summary" aria-label="Resumen de idiomas">
                <div className="neat-summary-item">
                    <span>Idiomas totales</span>
