    ...
    const manejarValidacionContrasenyas = async () => {
        ...
        if (contrasenya1 === contrasenya2) {
            if (
                ...
                const historicos = await getUsuarioPasswordHistoricos(JSON.stringify({ where: { usuarioId: usuarioId } }));
                ...
                await postUsuarioPasswordHistorico({ usuarioId: usuarioId, password: hashedPassword });
                ...
                setMessage('La contraseña debe tener al menos 1 mayúscula, 1 minúscula, 1 número y tener al menos 8 caracteres');
                bloquearPantalla(false);
            }
        }
        else {
